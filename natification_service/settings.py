"""
Django settings for natification_service project.
...
ROOT_URLCONF = 'natification_service.urls'
...
WSGI_APPLICATION = 'natification_service.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'natification_service/static'), ]
