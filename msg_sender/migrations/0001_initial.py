    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_details', models.JSONField(blank=True, null=True, verbose_name='employee_requisites')),
                ...
                ('channels', models.ForeignKey(blank=True, max_length=255, null=True, on_delete=django.db.models.deletion.CASCADE, to='msg_sender.channel', verbose_name='channels for send')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ManyToManyField(blank=True, to='msg_sender.channel', verbose_name='channel')),
