...
class Notification(models.Model):
    ...
    channel_name = models.ForeignKey(Channel, verbose_name='channel_name', on_delete=models.CASCADE,
                                     blank=True)
    ntf_group = models.ForeignKey(Notification_group, verbose_name='channel_name', on_delete=models.CASCADE,
                                  blank=True)
